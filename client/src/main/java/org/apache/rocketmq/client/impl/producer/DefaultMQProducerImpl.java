            ...
            for (; times < timesTotal; times++) {
                ...
                if (mqSelected != null) {
                    ...
                    try {
                        ...
                        //把消息投送到broker上去
                        sendResult = this.sendKernelImpl(msg, mq, communicationMode, sendCallback, topicPublishInfo, timeout - costTime);//剩余的时间
            ...
            try {
                ...
                switch (communicationMode) {
                    case ASYNC:
                        ...
                        if (msgBodyCompressed) {//如果消息被压缩，就进行处理
